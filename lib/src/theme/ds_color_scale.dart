...
class DsColorScale {
  ...
  int get hashCode => Object.hash(
        backgroundDefault, backgroundTinted, surfaceDefault, surfaceTinted,
        surfaceHover, surfaceActive, borderSubtle, borderDefault,
        borderStrong, textSubtle, textDefault, baseDefault,
        baseHover, baseActive, baseContrastSubtle, baseContrastDefault,
      );
}
