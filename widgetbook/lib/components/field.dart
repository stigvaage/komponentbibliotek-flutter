...
final fieldComponent = WidgetbookComponent(
  ...
  useCases: [
    WidgetbookUseCase(
      name: 'Standard',
      builder: (context) {
        final label = context.knobs.string(label: 'Etikett', initialValue: 'E-post');
        final description = context.knobs.string(label: 'Beskrivelse', initialValue: 'Skriv inn e-postadressen din');
