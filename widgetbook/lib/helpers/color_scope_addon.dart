...
class DsColorScopeAddon extends WidgetbookAddon<DsColor> {
  DsColorScopeAddon() : super(name: 'Fargeskala');
  ...
  @override
  Widget buildUseCase(BuildContext context, Widget child, DsColor setting) {
    return DsColorScope(color: setting, child: child);
  }
}
